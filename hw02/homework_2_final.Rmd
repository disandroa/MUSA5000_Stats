...
```{r queen_matrix, warning=FALSE, message=FALSE}
...
```{r scatter_LNMEDHVAL, warning=FALSE, message=FALSE, cache=FALSE, fig.cap="Figure 2."}
...
```{r LISA_p_plot, warning=FALSE, message=FALSE, cache=FALSE, fig.cap="Figure 3."}
...
```{r WT_OLS_plot, warning=FALSE, message=FALSE, cache=FALSE, fig.cap="Figure 5."}
...
```{r regressing_resids, warning=FALSE, message=FALSE, cache=FALSE}
...
```{r ols_morans_hist, warning=FALSE, message=FALSE, cache=FALSE, fig.cap = "Figure 6."}
...
```{r lag_morans_hist, warning=FALSE, message=FALSE, cache=FALSE, fig.cap = "Figure 7."}
...
```{r spatial_lag_plot, warning=FALSE, message=FALSE, cache=FALSE, fig.cap="Figure 8."}
...
```{r warning=FALSE, message=FALSE, cache=FALSE, echo=TRUE,results='hide'}
