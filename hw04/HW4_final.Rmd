...
```{r popmap, fig.cap="Fig 5. Philadelphia Farmers Markets and Population by ZIP Code"}
# create map
ggplot() +
...
```{r FM_map_income, fig.cap="Fig 6. Philadelphia Farmers Markets and Median HH Income by ZIP Code"}
# create map
ggplot() +
